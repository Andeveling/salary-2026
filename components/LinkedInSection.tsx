...
const LinkedInSection: React.FC<LinkedInSectionProps> = ({
	...
	const placeholders = {
		...
		github:
			"Ejemplo (Pega tu README.md principal aquí):\n\n# Portfolio de Juan Dev\n\n## Proyectos Destacados\n1. E-commerce API: Node.js + GraphQL.\n2. Open Source Contrib: Corrección de bugs en biblioteca React-Query...",
	};

	const tooltips = {
		linkedin:
			"Ve a tu perfil de LinkedIn > 'Más' > 'Guardar en PDF' o simplemente selecciona y copia todo el texto de tu sección 'Acerca de', 'Experiencia' y 'Educación'. Entre más detalles técnicos, mejor la estimación.",
		github:
			"Copia el contenido de tu README.md personal (el que sale en tu perfil) o la descripción de tus repositorios más importantes. La IA buscará calidad de código, complejidad de proyectos y stack tecnológico.",
	};
				...
				<div className="mt-6 animate-fadeIn space-y-6">
					...
					<div className="relative">
						<div className="flex justify-between items-center mb-2">
							<label
								htmlFor={`profile-${activeTab}`}
								className="text-xs font-bold uppercase block"
							>
								{activeTab === "linkedin"
									? "Pega tu Info Profesional"
									: "Pega tu README / Proyectos"}
							</label>
